...
export default function Footer() {
    const links = [
        ...
        {
            id: 5,
            href: 'https://github.com/mrExplorist/autofloww',
    ...
    return (
        <footer className="mt-32 mb-16 sm:mb-0 px-6 sm:px-[5%]">
            <div className="border-b border-b-zinc-600 pb-16">
                <span className="sr-only">AUTOFLOWW</span>
                <div className="flex items-center justify-center w-full py-2">
                    <h2 className="md:text-[12rem] text-4xl uppercase font-extrabold text-light-gray ">AUTOFLOWW</h2>
                </div>
            </div>
            <div className="flex flex-col gap-y-12 gap-x-2 md:flex-row items-start justify-between pt-10 pb-10 text-text">
