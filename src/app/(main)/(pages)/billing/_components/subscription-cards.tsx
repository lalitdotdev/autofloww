...
export const SubscriptionCards = ({ onPayment, products, tier }: SubscriptionCardsProps) => {
    console.log(products)
    return (
        <section className="flex md:flex-row flex-col w-full justify-center gap-6">
            {products &&
                            ...
                            <CardDescription>
                                {product.nickname == 'Unlimited'
                                    ...
                                    : product.nickname == 'Pro'
                                        ...
                                        "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into Floww's automation capabilities."}
                            </CardDescription>
